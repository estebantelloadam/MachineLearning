...
class ClassificationModel:
    ...
    def evaluate(self, X_test, y_test_class):
        loss, accuracy = self.model.evaluate(X_test, y_test_class)
...
class RegressionModel:
    ...
    def evaluate(self, X_test, y_test_reg):
        mse = self.model.evaluate(X_test, y_test_reg)
...
def main():
    ...
    _, _, y_train_reg, y_test_reg = train_test_split(X, y_reg, test_size=0.2, random_state=42)  # We can reuse X_train and X_test
